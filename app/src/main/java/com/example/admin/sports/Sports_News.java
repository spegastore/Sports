...
public class Sports_News extends AppCompatActivity {

    RecyclerView recyclerView_news;
    Recycler_News adapter;
    List<Dataclass_News> datanews;
    ImageView icon;
    ProgressBar bar;

    private static final String TAG = Sports_News.class.getSimpleName();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sports__news);
        getSupportActionBar().hide();
        final String url = "http://www.spegasports.com/admin/get_alldata.php";
        ...
        icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Sports_News.this, Sports_Menu.class);
                startActivity(intent);
                overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
            }
        });
        recyclerView_news = (RecyclerView) findViewById(R.id.news_recycler);
    ...
    private class Generate extends AsyncTask<String, Void, Integer> {
        ...
        protected void onPostExecute(Integer result) {
            ...
            if(result==1)
            {
                ...
                Recycler_News adapter=new Recycler_News(Sports_News.this,datanews);
